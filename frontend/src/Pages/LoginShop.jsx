                    ...
                    <form className='space-y-6' onSubmit={handleSubmit}>
                        ...
                        <div className={`${styles.normalFlex} justify-between`}>
                            <div className={`${styles.normalFlex}`}>
                                <input type="checkbox" name='remember-mre' id='remember-me' className='h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded' />
                                <label htmlFor="remember-me" className='ml-2 block text-sm textgray-900'>Remember me</label>
                            </div>
                        ...
                        <div className={`${styles.normalFlex} w-full`}>
                            ...
                            <Link to="/create-shop" className='text-blue-600 pl-2'> Sign Up</Link>
                        </div>
                    </form>
                </div>
            </div>
